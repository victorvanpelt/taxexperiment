...
class Constants(BaseConstants):
    name_in_url = 'publictax_agg'
    players_per_group = None
    num_rounds = 1
    completion_code = '2957192'
    AgreeChoices = [
        [1, 'Strongly disagree'],
        [2, 'Disagree'],
        [3, 'Somewhat disagree'],
...
class Player(BasePlayer):
    ...
    Instr3 = models.IntegerField(
        ...
        choices=[[1, 'True'], [2, 'False']],
        widget=widgets.RadioSelect,
        label='The more Telecom Co. invests in business operations in Country A, the fewer taxes it effectively pays in Country A.',
    )
    Instr4 = models.IntegerField(
        blank=False,
        choices=[[1, 'True'], [2, 'False']],
        widget=widgets.RadioSelect,
        label='The tax rate of Country B is higher than Country A.',
    )
    Instr5 = models.IntegerField(
        blank=False,
        choices=[[1, 'True'], [2, 'False']],
        widget=widgets.RadioSelect,
        label='Telecom Co. can pay less tax in Country A by shifting profits from Country A to Country B, which creates a tax difference due to foreign profits.',
    )
